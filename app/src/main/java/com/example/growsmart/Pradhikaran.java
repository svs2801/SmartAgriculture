...
public class Pradhikaran extends AppCompatActivity {
    ImageView btMenu;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pradhikaran);
        ...
        this.btMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Pradhikaran.this.drawerLayout.openDrawer(GravityCompat.START);
            }
        });
    }
