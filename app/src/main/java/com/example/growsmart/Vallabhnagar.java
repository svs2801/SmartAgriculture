...
public class Vallabhnagar extends AppCompatActivity {
    ImageView btMenu;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vallabhnagar);
        ...
        this.btMenu.setOnClickListener(new View.OnClickListener() {
            /* class com.android_coding.navigationdrawer.Morwadi.AnonymousClass1 */

            public void onClick(View v) {
                Vallabhnagar.this.drawerLayout.openDrawer(GravityCompat.START);
            }
        });
    }
